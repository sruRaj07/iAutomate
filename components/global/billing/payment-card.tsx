  ...
  return (
    <div className={cn( 
        label != current ? 'bg-in-active'
         ...
         'p-[2px] ounded-xl overflow-hidden'
        )}
    >
        <div 
           className={cn(
        ...
        >
            ...
            {label === 'PRO' ? (
                <span className="bg-gradient-to-r text-3xl from-indigo-500 via-purple-500 forn-bold
            ...
            {PLANS[label === 'PRO' ? 1:0].features.map((i) => (
                <p
                key={i}
                className="mt-2 ext-muted-foreground flex gap-2"
                >
